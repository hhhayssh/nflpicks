...
public class CollectivePickAccuracySummary {
	...
	public CollectivePickAccuracySummary(){
	}
	
	public CollectivePickAccuracySummary(Team team, int actualWins, int actualLosses, int actualTies, int predictedWins, int predictedLosses, int timesRight, int timesWrong,
	...
	public String toString(){
		...
		String thisObjectAsAString = "team = " + team + 
